...
class EngiProofTests(unittest.TestCase):
    ...
    def test_registry(self):
        self.assertEqual([x['paper_id'] for x in list_studies()],['P08','P12','P16','P29','P36','P38'])
    ...
    def test_verify(self):
        for pid in ('P08','P12','P16','P29','P36','P38'):
            v=verify_study(pid)
    ...
    def test_schema_backward_compatibility(self):
        ...
        for pid in ('P16','P29','P36'):
            self.assertEqual(load_manifest(pid)['schema_version'],'engiproof.study/1.1')
